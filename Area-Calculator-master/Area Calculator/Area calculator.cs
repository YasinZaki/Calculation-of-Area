...
namespace U16_Modular_Calculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (calcloop == true)
            {
                //this is for choosing what they want to calculate the area for//
                Console.WriteLine("\nMenu");
                ...
                //for the user to put in the numbers//
                ...
                switch (opChoice)
                {
                    ...
                    case 3:
                        ...
                        //this file helps the user know what to do//
                        break;
                    case 4:
                ...
                //the user can calculate the area of any shape//
                Console.WriteLine("");
